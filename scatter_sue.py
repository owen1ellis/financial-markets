...
np.random.seed(42)
n_points = 30
sentiment_shift = np.random.uniform(-0.8, 0, n_points)
...
fig_sue.update_layout(height=500, width=700)
fig_sue.add_hline(y=0, line_dash="dot", line_color="black")
fig_sue.add_vline(x=0, line_dash="dot", line_color="black")
# fig_sue.show()